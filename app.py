...
if __name__ == '__main__':
    app.run(debug=True)
# this code references Satish2611 (2020) and alliecarlile (2023) to return stations and return stats for temperature data. 
# https://github.com/Satish2611/sqlalchemy-challenge
# https://github.com/alliecarlile/sqlalchemy-Hawaii-analysis